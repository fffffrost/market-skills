...
export const installPageCopy = {
  ...
  zh: {
    ...
    manualTitle: "也可以手动安装", manualBody: "把目标 Skill 目录复制到宿主的 skills 目录，保留 SKILL.md、references 和 agents 的相对结构。",
    trustTitle: "安装前，先看源码。", trustBody: "Agent Skill 会影响模型怎样执行任务。使用前检查触发条件、引用、外部依赖和工具权限。",
