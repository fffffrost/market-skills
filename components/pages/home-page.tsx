...
const copy = {
  ...
  zh: {
    ...
    hero: <>进入中国市场，<br /><span>从证据开始。</span></>,
    ...
    installHeading: <>一次安装，<br />得到中国市场工作层。</>,
