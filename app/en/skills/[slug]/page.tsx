...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return createPageMetadata({
    title: isChinaCompetitorTemplate ? chinaCompetitorTemplate.seoTitle : `${skill.title} AI Skill`,
    description: isChinaCompetitorTemplate ? chinaCompetitorTemplate.seoDescription : skill.summary,
